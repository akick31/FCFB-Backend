...
class LeagueStatsService(
     ...
     */
    fun getLeagueStatsBySubdivisionAndSeason(subdivision: Subdivision, seasonNumber: Int): LeagueStats? {
     ...
     */
    fun generateLeagueStatsForSubdivisionAndSeason(subdivision: Subdivision, seasonNumber: Int) {
     ...
     */
    fun leagueStatsExistForSubdivisionAndSeason(subdivision: Subdivision, seasonNumber: Int): Boolean {
