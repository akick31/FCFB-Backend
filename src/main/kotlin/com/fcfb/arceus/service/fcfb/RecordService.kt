...
class RecordService(
     ...
     */
    private val dualRecordStats = setOf(
     ...
     */
    private val generalRecordStats = setOf(
        Stats.LONGEST_PASS,
        Stats.LONGEST_RUN,
     ...
     */
    private val gameOnlyStats = setOf(
        Stats.TIME_OF_POSSESSION,
     ...
     */
    fun getRecord(recordName: Stats, recordType: RecordType): Record? {
     ...
     */
    fun generateRecord(recordName: Stats, recordType: RecordType) {
     ...
     */
    private fun generateGameRecord(statName: Stats, gameStatsList: List<GameStats>, recordType: RecordType) {
        val isLowest = recordType == RecordType.SINGLE_GAME_LOWEST
        val bestGameStats = if (isLowest) {
     ...
     */
    private fun generateSeasonRecord(statName: Stats, gameStatsList: List<GameStats>, recordType: RecordType) {
        ...
        val teamSeasonTotals = allGameStats
        ...
        val bestTeamSeason = if (isLowest) {
     ...
     */
    private fun generateGeneralRecord(statName: Stats, gameStatsList: List<GameStats>, recordType: RecordType) {
     ...
     */
    private fun checkAndUpdateGameRecord(statName: Stats, gameStatsList: List<GameStats>, game: Game, recordType: RecordType) {
        ...
        for (gameStats in gameStatsList) {
            ...
            val isNewRecord = if (recordType == RecordType.SINGLE_GAME_LOWEST) {
     ...
     */
    private fun checkAndUpdateSeasonRecord(statName: Stats, gameStatsList: List<GameStats>, game: Game, recordType: RecordType) {
        val currentRecord = recordRepository.findTopByRecordNameAndRecordTypeOrderByRecordValueDesc(statName, recordType)
     ...
     */
    private fun checkAndUpdateGeneralRecord(statName: Stats, gameStatsList: List<GameStats>, game: Game, recordType: RecordType) {
        val currentRecord = recordRepository.findTopByRecordNameAndRecordTypeOrderByRecordValueDesc(statName, recordType)
        ...
        for (gameStats in gameStatsList) {
            ...
            val isNewRecord = if (recordType == RecordType.GENERAL_LOWEST) {
                currentValue < recordValue
            } else {
                currentValue > recordValue
            }
     ...
     */
    private fun getStatValue(statName: Stats, gameStats: GameStats): Double {
        val propertyName = when (statName) {
            // Basic Game Info
            Stats.SCORE -> "score"
     ...
     */
    private fun calculateAverageForStat(statName: Stats, gameStatsList: List<GameStats>): Double {
     ...
     */
    private fun calculatePercentageForStat(statName: Stats, gameStatsList: List<GameStats>): Double {
