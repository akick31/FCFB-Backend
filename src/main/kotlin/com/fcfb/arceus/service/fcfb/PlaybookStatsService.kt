...
class PlaybookStatsService(
    ...
    fun getPlaybookStatsByOffensivePlaybookAndDefensivePlaybookAndSeason(
        ...
        return playbookStatsRepository.findByOffensivePlaybookAndDefensivePlaybookAndSeasonNumber(
            offensivePlaybook, defensivePlaybook, seasonNumber
        )
    }
    ...
    fun generateAllPlaybookStats() {
        ...
        val groupedStats = allGameStats.groupBy { 
        ...
        for ((playbookSeason, gameStatsList) in groupedStats) {
            ...
            if (seasonNumber != null) {
                Logger.info("Generating playbook stats for $offensivePlaybook/$defensivePlaybook in season $seasonNumber with ${gameStatsList.size} games")
     ...
     */
    fun generatePlaybookStatsForOffensivePlaybookAndSeason(offensivePlaybook: OffensivePlaybook, seasonNumber: Int) {
        ...
        val gameStatsList = gameStatsRepository.findBySeasonOrderByGameIdAsc(seasonNumber)
     ...
     */
    fun generatePlaybookStatsForDefensivePlaybookAndSeason(defensivePlaybook: DefensivePlaybook, seasonNumber: Int) {
    ...
    private fun aggregateGameStatsToPlaybookStats(
        ...
        return PlaybookStats(
            ...
            passCompletionPercentage = calculatePercentage(
            ...
            passSuccessPercentage = calculatePercentage(
            ...
            rushSuccessPercentage = calculatePercentage(
     ...
     */
    fun playbookStatsExistForOffensivePlaybookAndSeason(offensivePlaybook: OffensivePlaybook, seasonNumber: Int): Boolean {
     ...
     */
    fun playbookStatsExistForDefensivePlaybookAndSeason(defensivePlaybook: DefensivePlaybook, seasonNumber: Int): Boolean {
