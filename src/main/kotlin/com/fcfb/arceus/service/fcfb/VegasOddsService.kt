...
class VegasOddsService {
     ...
     */
    fun calculateVegasOdds(homeTeam: Team, awayTeam: Team): VegasOddsResponse {
     ...
     * @return VegasOddsResponse with home and away spreads
     */
    fun calculateVegasOdds(homeElo: Double, awayElo: Double, homeTeamName: String? = null, awayTeamName: String? = null): VegasOddsResponse {
        logger.info("Calculating Vegas odds: ${homeTeamName ?: "Home"} (${homeElo.toInt()}) vs ${awayTeamName ?: "Away"} (${awayElo.toInt()})")
     ...
     */
    private fun calculateVegasSpread(teamElo: Double, opponentElo: Double): Double {
