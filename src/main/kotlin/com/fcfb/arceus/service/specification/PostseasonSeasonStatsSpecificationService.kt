...
@Service
class PostseasonSeasonStatsSpecificationService {
    fun createSpecification(
        team: String?,
        season: Int?,
    ): Specification<PostseasonSeasonStats> {
        return Specification { root: Root<PostseasonSeasonStats>, _: CriteriaQuery<*>, cb: CriteriaBuilder ->
