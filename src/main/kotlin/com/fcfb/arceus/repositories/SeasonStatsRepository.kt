...
interface SeasonStatsRepository : JpaRepository<SeasonStats, Int> {
     ...
     */
    fun findByTeamAndSeasonNumber(team: String, seasonNumber: Int): SeasonStats?
     ...
     */
    fun findBySubdivisionAndSeasonNumber(subdivision: String, seasonNumber: Int): List<SeasonStats>
    ...
    fun findTopTeamsByWins(@Param("seasonNumber") seasonNumber: Int): List<SeasonStats>
    ...
    fun findTopTeamsByTotalYards(@Param("seasonNumber") seasonNumber: Int): List<SeasonStats>
    ...
    fun findTopTeamsByPassYards(@Param("seasonNumber") seasonNumber: Int): List<SeasonStats>
    ...
    fun findTopTeamsByRushYards(@Param("seasonNumber") seasonNumber: Int): List<SeasonStats>
    ...
    fun findTopTeamsByTouchdowns(@Param("seasonNumber") seasonNumber: Int): List<SeasonStats>
    ...
    fun findTopTeamsByTurnoverDifferential(@Param("seasonNumber") seasonNumber: Int): List<SeasonStats>
     ...
     */
    fun deleteByTeamAndSeasonNumber(team: String, seasonNumber: Int)
    
    /**
     * Check if season stats exist for a team and season
     */
    fun existsByTeamAndSeasonNumber(team: String, seasonNumber: Int): Boolean
