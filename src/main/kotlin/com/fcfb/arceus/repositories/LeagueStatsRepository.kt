...
@Repository
interface LeagueStatsRepository : CrudRepository<LeagueStats, Int> {
    
    fun findAllByOrderBySeasonNumberDescSubdivisionAsc(): List<LeagueStats>
    
    fun findBySubdivisionAndSeasonNumber(subdivision: com.fcfb.arceus.enums.team.Subdivision, seasonNumber: Int): LeagueStats?
