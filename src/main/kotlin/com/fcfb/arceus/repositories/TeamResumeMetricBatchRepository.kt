    ...
    fun batchInsert(rows: List<TeamResumeMetric>) {
        ...
        val sql =
            ...
            INSERT INTO team_resume_metric (
                ...
                q1_wins, q1_losses, th_wins, th_losses, q4_wins, q4_losses,
        ...
        jdbcTemplate.batchUpdate(
            ...
            ps.setInt(10, row.thWins)
            ps.setInt(11, row.thLosses)
            ps.setInt(12, row.q4Wins)
            ps.setInt(13, row.q4Losses)
            ps.setInt(14, row.t25Wins)
            ps.setInt(15, row.t25Losses)
            ps.setInt(16, row.t50Wins)
            ps.setInt(17, row.t50Losses)
            ps.setInt(18, row.t100Wins)
            ps.setInt(19, row.t100Losses)
            row.avgOpponentCompositeRank?.let { ps.setDouble(20, it) } ?: ps.setNull(20, Types.DOUBLE)
            row.compositeSos?.let { ps.setDouble(21, it) } ?: ps.setNull(21, Types.DOUBLE)
        }
    }
}
