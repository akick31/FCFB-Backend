...
class ConferenceStatsController(
    ...
    fun getConferenceStatsBySubdivisionAndConferenceAndSeason(
        ...
        val subdivisionEnum = try {
            Subdivision.valueOf(subdivision.uppercase())
        } catch (e: IllegalArgumentException) {
            return ResponseEntity.badRequest().build()
        }
        
        val conferenceEnum = try {
            Conference.valueOf(conference.uppercase())
        } catch (e: IllegalArgumentException) {
            return ResponseEntity.badRequest().build()
        }
        
        val conferenceStats = conferenceStatsService.getConferenceStatsBySubdivisionAndConferenceAndSeason(subdivisionEnum, conferenceEnum, seasonNumber)
    ...
    fun getConferenceStatsBySubdivision(@RequestParam subdivision: String): ResponseEntity<List<ConferenceStats>> {
        val subdivisionEnum = try {
            Subdivision.valueOf(subdivision.uppercase())
        } catch (e: IllegalArgumentException) {
            return ResponseEntity.badRequest().build()
    ...
    fun getConferenceStatsByConference(@RequestParam conference: String): ResponseEntity<List<ConferenceStats>> {
        val conferenceEnum = try {
            Conference.valueOf(conference.uppercase())
        } catch (e: IllegalArgumentException) {
            return ResponseEntity.badRequest().build()
     ...
     */
    @GetMapping("/season")
    fun getConferenceStatsBySeason(@RequestParam seasonNumber: Int): ResponseEntity<List<ConferenceStats>> {
    ...
    fun generateConferenceStatsForSubdivisionAndConferenceAndSeason(
        ...
        return try {
            conferenceStatsService.generateConferenceStatsForSubdivisionAndConferenceAndSeason(subdivisionEnum, conferenceEnum, seasonNumber)
